			...
			<div class="panel-body">
				{!! Form::open(['class' => 'form-horizontal']) !!}
					<div class="form-group">
						...
						<div class="col-sm-5">
							{!! Form::text('sd_extension',null,['class' => 'form-control'])!!}
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group" id="confbridge">
						...
						<div class="col-sm-5">
							{!! Form::select('confbridge',Auth::user()->Customer->ConferenceBridges->lists('conf_name','id'),null,['class' => 'form-control']) !!}
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-5 col-sm-offset-4">
							<button class="btn btn-default" type="submit">Create Speed Dial</button>
						</div>
					</div>
				{!! Form::close() !!}
				@if ($errors->any())
