			...
			<div class="panel-body">
				{!! Form::open(['class' => 'form-horizontal']) !!}
					<div class="form-group">
						...
						<div class="col-sm-5">
							{!! Form::text('rg_name',$RingGroup->rg_name,['class' => 'form-control'])!!}
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Ring Type</label>
						<div class="col-sm-5">
							{!! Form::select('rg_type',['1' => 'Ring All','2' => 'Hunt'],$RingGroup->rg_type,['class' => 'form-control'])!!}
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Ring Time</label>
						<div class="col-sm-5">
							{!! Form::text('rg_time',$RingGroup->rg_time,['class' => 'form-control'])!!}
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4">Ring Users</label>
						<div class="col-sm-5">
							{!! Form::select('ring_users[]',Auth::user()->Customer->Users->lists('fullname','id'),json_decode($RingGroup->rg_members,true),['class' => 'form-control','multiple' => 'multiple','size' => '10','id' => 'ring_users'])!!}
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							{!! Form::select('destination_type',['forward' => 'Forward','extension' => 'Dial Extension','ivr' => 'Auto Attendant','ringgroup' => 'Ring Group','schedule' => 'Scheduler','confbridge' => 'Conference Bridge','voicemail' => 'Voicemail','queue' => 'Call Queue','busy' => 'Busy','hangup' => 'Hangup',],$RingGroup->rg_dest_type,['class' => 'form-control','id' => 'destination_type']) !!}
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-5 col-sm-offset-4">
							...
							<label class="control-label">Delete Ring Group</label>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-5 col-sm-offset-4">
							<button class="btn btn-default" type="submit">Update Ring Group</button>
						</div>
					</div>
				{!! Form::close() !!}
				@if ($errors->any())
...
@section('bottom')
<script type="text/javascript" src="/assets/js/ringgroups/edit.js"></script>
@stop